...
default['jenkins_cf']['inner_bosh']['director_ip']     			= 'localhost'			# Full BOSH director floating ip to be used
default['jenkins_cf']['inner_bosh']['powerdns_ip']     			= 'localhost'			# Full BOSH powerdns floating ip to be used
default['jenkins_cf']['inner_bosh']['user']						= 'admin'				# Full BOSH username
default['jenkins_cf']['inner_bosh']['pass']						= 'admin'				# Full BOSH password
default['jenkins_cf']['inner_bosh']['net_id']						= ''					# The quantum/neutron network id to use for private ip assignments

default['jenkins_cf']['cloud_controller']['ip']				= ''					# Floating IP the cloud controller should use
default['jenkins_cf']['cloud_controller']['root_domain']	= ''					# Root domain that a
